...
def WRResNet(input_shape=(120, 120, 3), classes=6, depth=24, k=4):
...
def basic_block(X, f, filters, stage, block, stride=1):
    ...
    X_shortcut = tf.keras.layers.AveragePooling2D(pool_size=stride,strides=stride)(X_shortcut)
